...
export const CLIPPY_MSGS: Record<string, ClippyMsg[]> = {
    greet: [
        ...
        {text:'Знакомы? Я Скрепка — твой персональный помощник!', anim:'wave'},
    ...
    tip_general: [
        ...
        'Знаешь, что можно перетаскивать ярлыки прямо на рабочем столе?',
        'Совет: в Мой компьютер → диск D: находятся твои закладки браузера.',
        'Кажется, ярлыков стало много. Попробуй организовать их в папки!',
        ...
        'Совет: зажми Ctrl и кликай для выделения нескольких ярлыков сразу.',
    ...
    app_calculator: [
        ...
        'Если результат тебя пугает — попробуй ввести заново.',
        {text:'Математику придумали, чтобы не считать в уме. Пользуйся!', anim:'wave'},
    ...
    app_solitaire: [
        ...
        'Удачи с картами! Иногда партия принципиально непроходима — не переживай.',
    ...
    app_hearts: [
        'В Червах старайся не брать взятки с очками!',
    ...
    app_mycomputer: [
        'Мой компьютер: диск C: — твои ярлыки, диск D: — закладки браузера.',
    ...
    app_paint: [
        'В Paint используй правую кнопку для рисования фоновым цветом.',
    ...
    app_cmd: [
        'Попробуй команды: help, ver, date, echo, cls.',
    ...
    react_bsod: [
        ...
        {text:'Не волнуйся, это просто пасхалка!', anim:'wave'},
    ...
    react_minesweeper_win: [
        {text:'Поздравляю! Ты прошёл сапёра!', anim:'excited'},
    ...
    react_solitaire_win: [
        {text:'Косынка пройдена! Ты молодец!', anim:'excited'},
    ...
    react_many_windows: [
        {text:'У тебя открыто много окон! Может, свернёшь лишние?', anim:'think'},
    ...
    idle_random: [
        ...
        'Знаешь, что ярлыки можно переупорядочить перетаскиванием?',
        ...
        {text:'Попробуй диск D: в Мой компьютер — там твои закладки браузера!', actions:[{label:'Открыть', fn:'clippyOpenMyComputer'}]},
        'Совет дня: экспортируй ярлыки перед переустановкой браузера.',
